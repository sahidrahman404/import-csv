...
sed -i "s/N\/A//g" PS4_GamesSales.csv
...
\copy ps4_sales(game, year, genre, publisher, north_america, europe, japan, restof_world, global) FROM '/home/rahman/test/PS4_GamesSales.utf8.csv' DELIMITER ',' CSV HEADER;
#+end_src
